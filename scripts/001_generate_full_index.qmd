...
write_csv(metadata, file = here("data", "final-data", paste0("metadata_outcome_year_", outcome_year, "_census_year_", census_year,".csv")))

data_catalog_index %>%
  write_csv(here("data", "final-data", paste0("data_catalog_index_outcome_year_", outcome_year, "_census_year_", census_year, ".csv")))

comms_index %>%
  write_csv(file = here("data", "final-data", paste0("comms_index_outcome_year_", outcome_year, "_census_year_", census_year, ".csv")))
```
